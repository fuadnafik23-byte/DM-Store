...
function DetailGame({ games }) {
  ...
  return (
    <div className="container-detail" style={{ position: 'relative' }}>
      ...
      {errorToast && (
        <div className="toast-warning" style={{
          ...
          <span style={{ backgroundColor: '#ef4444', color: '#fff', borderRadius: '50%', width: '18px', height: '18px', display: 'flex', alignItems: 'center', justifyCenter: 'center', fontSize: '11px' }}>X</span>
          {errorToast}
        </div>
      )}
